...
def main():
    ...
    c=answer_question(q(qs,"Q13"),dossiers); cm=copy.deepcopy(c); cm["answer_status"]="SUPPORTED"; killed.append(("remove_contradiction_classification",cm["answer_status"]!=c["answer_status"]))
    ...
    else: som["answer_status"]="SUPPORTED"
    killed.append(("remove_social_distinction",som!=so))
