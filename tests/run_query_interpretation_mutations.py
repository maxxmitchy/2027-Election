...
def main():
    ...
    checks.append(run('remove_geography','How much did inflation increase between 2022 and 2023?',lambda q:{**q,'geography':None},lambda a,b:a['geography']!=b['geography']))
    ...
    checks.append(run('allow_retrieval_reinterpretation','Did Tinubu cause inflation to rise?',lambda q:{**q,'operation':'FACTUAL_LOOKUP'},lambda a,b:a['operation']!=b['operation']))
