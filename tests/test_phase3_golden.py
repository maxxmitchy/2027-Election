...
("contradiction","What conflicting evidence exists about Anambra's debt during Obi's tenure?","INSUFFICIENT_EVIDENCE"),
...
("negative knowledge","Does the database establish that Peter Obi left Anambra with zero debt?","NO_MATCH"),
...
("negative unknown","What happened to an unsupported topic for Atiku?","NO_MATCH"),
...
def test_quantitative_lineage():
    a=present("How did Nigeria's headline inflation change during the selected Tinubu period?",ROOT); assert a["calculations"] and a["observations"] and a["methodology"]; assert a["evidence_status"]=="SUPPORTED"
