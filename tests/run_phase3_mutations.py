...
def validate_answer(a):
    ...
    p=a.get("provenance",{}); required=("answer_id","query_id","interpretation_version","methodology_version","database_snapshot","generation_timestamp","source_versions")
