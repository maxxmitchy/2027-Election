...
def interpret(raw_question):
    ...
    if len(scope)>1 and operation not in {"COMPARISON","COUNT","COVERAGE"}:status="PARTIALLY_INTERPRETED";ambiguities.append("Multiple candidate subjects require an explicit comparison or aggregate operation.")
