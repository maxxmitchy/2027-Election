...
import hashlib, re
CANDIDATE_ALIASES={"bola-ahmed-tinubu":("tinubu","bola tinubu","bola ahmed tinubu"),"peter-gregory-obi":("obi","peter obi","peter gregory obi"),"atiku-abubakar":("atiku","atiku abubakar")}
